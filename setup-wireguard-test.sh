...
echo ""
echo "3. Test with UDP tunnel (persistent identity):"
echo ""
echo "   Terminal 2 - Start sender (on server side):"
echo "   udp-tunnel sender --target 127.0.0.1:$WG_SERVER_PORT --secret-file ./wg-test/sender.key"
echo "   # Note the Fixed EndpointId (same across restarts)"
echo ""
...
echo "   ping $WG_SERVER_IP"
echo ""
echo "   Note: The sender.key file will be created on first run and reused"
echo "         This allows the receiver to reconnect after sender restarts"
echo ""
echo "4. Cleanup:"
